...
class MakeMetricOverviewWidget extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:metric-overview-widget {name?} {--R|resource=} {--C|chart} {--T|table} {--S|stats-overview} {--panel=} {--F|force}';
     ...
     * @var string
     */
    protected $description = 'Create a new metric overview widget class';
