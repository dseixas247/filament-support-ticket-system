...
class MakeMetricWidget extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:metric-widget {name?} {--R|resource=} {--C|chart} {--T|table} {--S|stats-overview} {--panel=} {--F|force}';
     ...
     * @var string
     */
    protected $description = 'Create a new metric widget class';
